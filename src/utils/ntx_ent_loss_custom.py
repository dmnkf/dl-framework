# Copied from: https://github.com/oetu/MMCL-ECG-CMR/blob/main/mmcl/utils/ntx_ent_loss_custom.py
...
class NTXentLoss(MemoryBankModule):
    ...
    def forward(
        self, out0: torch.Tensor, out1: torch.Tensor, indices: List[int] = None
    ):
