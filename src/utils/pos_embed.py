# Copied from: https://github.com/oetu/MMCL-ECG-CMR/blob/main/mmcl/utils/pos_embed.py
...
def interpolate_pos_embed(model, checkpoint_model):
    if "pos_embed" in checkpoint_model:
        ...
        orig_width = int(
            (pos_embed_checkpoint.shape[-2] - num_extra_tokens) / orig_height
        )
        ...
        if orig_width != new_width:
            ...
            pos_tokens = pos_tokens.reshape(
                -1, orig_height, orig_width, embedding_size
            ).permute(0, 3, 1, 2)
